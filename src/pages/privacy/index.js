    ...
    return (
      <div className="showdow-box">
        <Helmet 
          ...
          />
       <h1 style={{fontSize: "25px"}}> Club AFIB. LLC PRIVACY POLICY </h1>
       ...
       <h2 style={{fontSize: "25px"}}>TABLE OF CONTENTS</h2>
       {Titles.map((item, index) => <p key={index} style={{cursor: 'pointer'}} onClick={e => this.moveToContent(index)}>
         <b>{item}</b>
       </p>)}
       <br/>

       <h2 style={{fontSize: "25px"}} ref={this.boxRefs[0]}>1. WHAT INFORMATION DO WE COLLECT?</h2><br />
       ...
       <h2 style={{fontSize: "25px"}} ref={this.boxRefs[1]}>2. HOW DO WE USE YOUR INFORMATION?</h2>
       ...
       <p>• Deliver targeted advertising to you. We may use your information to develop and display personalized content and advertising (and work with third parties who do so) tailored to your interests and/or location and to measure its effectiveness.</p>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[2]}>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[3]}>4. THIRD PARTIES</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[4]}>5. DO WE USE GOOGLE MAPS?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[5]}>6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[6]}>7. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[7]}>8. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[8]}>9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[9]}>10. DO WE COLLECT INFORMATION FROM MINORS?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[10]}>11. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[11]}>12. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[12]}>13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[13]}>14. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
        ...
        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[14]}>15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
        <p>If you have questions or comments about this notice, you may email us at support@clubafib.com</p>

        <h2 style={{fontSize: "25px"}} ref={this.boxRefs[15]}>16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?     </h2>
